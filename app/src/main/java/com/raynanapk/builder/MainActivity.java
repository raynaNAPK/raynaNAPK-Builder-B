...
public class MainActivity extends Activity {
    ...
    void showViewerV9(){
        ...
        if(needSplash){
            ...
            splash.addView(logo); splash.addView(tv); splash.addView(pb);
    ...
    void showBuilderV9(){
        ...
        TextView title=new TextView(this); title.setText("⚡ Builder B V9.1\n👑 FIXED SIGNING"); title.setTextSize(17); title.setTextColor(Color.parseColor("#FFD700")); title.setGravity(Gravity.CENTER); title.setPadding(0,0,0,6);
        appNameInput=new EditText(this); appNameInput.setHint("App Name"); appNameInput.setText("dadu"); appNameInput.setTextColor(Color.WHITE); appNameInput.setHintTextColor(Color.GRAY); appNameInput.setBackgroundColor(Color.parseColor("#1A1D2E")); appNameInput.setPadding(10,10,10,10);
        packageInput=new EditText(this); packageInput.setHint("Package"); packageInput.setText("com.khozenk.dadu"); packageInput.setTextColor(Color.WHITE); packageInput.setHintTextColor(Color.GRAY); packageInput.setBackgroundColor(Color.parseColor("#1A1D2E")); packageInput.setPadding(10,10,10,10);
        bannerInput=new EditText(this); bannerInput.setHint("Banner ID"); bannerInput.setTextColor(Color.WHITE); bannerInput.setHintTextColor(Color.GRAY); bannerInput.setBackgroundColor(Color.parseColor("#1A1D2E")); bannerInput.setPadding(8,8,8,8); bannerInput.setTextSize(9);
        interInput=new EditText(this); interInput.setHint("Inter ID"); interInput.setTextColor(Color.WHITE); interInput.setHintTextColor(Color.GRAY); interInput.setBackgroundColor(Color.parseColor("#1A1D2E")); interInput.setPadding(8,8,8,8); interInput.setTextSize(9);
        jsInjectInput=new EditText(this); jsInjectInput.setHint("JS Inject"); jsInjectInput.setTextColor(Color.WHITE); jsInjectInput.setHintTextColor(Color.GRAY); jsInjectInput.setBackgroundColor(Color.parseColor("#1A1D2E")); jsInjectInput.setPadding(8,8,8,8); jsInjectInput.setTextSize(9);
    ...
    void buildV9(boolean buildAAB){
        new Thread(() -> {
            try{
                runOnUiThread(() -> log("\n👑 BUILDING V9.1 "+(buildAAB?"AAB":"APK")+"..."));
                ...
                runOnUiThread(() -> log("> Signing with FIXED BC..."));
                // FIX BC PROVIDER - HAPUS PROVIDER LAMA, PASANG BARU
                try{ Security.removeProvider("BC"); }catch(Exception e){}
                BouncyCastleProvider bcProvider = new BouncyCastleProvider();
                Security.addProvider(bcProvider);
                Security.addProvider(new BouncyCastleProvider());
                KeyPairGenerator kpg=KeyPairGenerator.getInstance("RSA","BC"); kpg.initialize(2048); KeyPair kp=kpg.generateKeyPair();
            ...
            }catch(Exception e){ e.printStackTrace(); runOnUiThread(() -> log("❌ FIXED ERROR: "+e.toString())); }
        }).start();
    }
